...
class Werewolf(Creature):
    def __init__(self, name, gender, birthday: datetime, fur_color, dominance: bool, pack):
        super().__init__(name, gender, birthday)
...
class City: 
    def __init__(self, name: str, gender: str, birthday: datetime, fur_color, dominance: bool, pack):
        pass
